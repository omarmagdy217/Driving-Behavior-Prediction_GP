...
def analyse(data):
    ...
    for l in data:
        ...
        TurnPerfTemp, crossedTurn1 = VerticalTurnLRFromLRLane(
            line1_1, line1_2, crossedTurn1, x, y)
        if(TurnPerfTemp != 0):
            TurnPerf.append(TurnPerfTemp)

        TurnPerfTemp2, crossedTurn2 = HorizontalTurnLRFromRLLane(
            line2_1, line2_2, crossedTurn2, x, y)
        if(TurnPerfTemp2 != 0):
            TurnPerf.append(TurnPerfTemp2)

        TurnPerfTemp3, crossedTurn3 = VerticalTurnLRFromLRLane(
        ...
        PedPerf1, CrossedPedSign1 = PedstranianSignRight(
            Ped_sign1, CrossedPedSign1, x, y, Speed, PedPerf1)
        PedPerf2, CrossedPedSign2 = PedstranianSignUp(
...
# =============================================result================================================
    ...
    return (DevPerf + SpeedPerfTotal + PedPerfTotal + TurnPerfTotal) / 8
